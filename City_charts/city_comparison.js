function init() {
    ...
    Plotly.d3.csv("CBSA_MSA.csv", function (err, rows) {
...
function buildCharts(sample, sample2, sample3, sample4) {
    // scatter chart 1
    Plotly.d3.csv("employment.csv", function (err, rows) {
    ...
    // scatter chart 2
    Plotly.d3.csv("unemployment.csv", function (err, rows) {
        function unpack(rows, key) {
            return rows.map(function (row) { return row[key]; });
        }
        var trace = {
    ...
    // scatter chart 3
    Plotly.d3.csv("gdp.csv", function (err, rows) {
        function unpack(rows, key) {
            return rows.map(function (row) { return row[key]; });
        }
        var trace = {
    ...
    // scatter chart 4
    Plotly.d3.csv("pop.csv", function (err, rows) {
    ...
    // scatter chart 5
    Plotly.d3.csv("business.csv", function (err, rows) {
    ...
    // scatter chart 6
    Plotly.d3.csv("annual_wage.csv", function (err, rows) {
    ...
    // scatter chart 7
    Plotly.d3.csv("labor.csv", function (err, rows) {
    ...
    Plotly.d3.csv("ArimaRank.csv", function (err, rows) {
